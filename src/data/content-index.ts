...
export const CONTENT: ContentEntry[] = [
  ...
  { slug: 'only-3-of-30-publish-a-price', cluster: 'research', title: 'Only 3 of 30 Software Companies Publish a Price', label: 'PRICING STUDY', blurb: 'Pricing opacity is near-universal in this market, which makes publishing one the cheapest differentiator available.', target: 'custom software pricing transparency' },
  { slug: 'guarantees-in-the-ad-library', cluster: 'research', title: 'Only 4 of 30 Offer a Guarantee', label: 'OFFER STUDY', blurb: 'And three of those four run the longest-lived ads in the set. The exact wording of each.', target: 'software development guarantee' },
  { slug: 'ad-longevity-as-a-conversion-proxy', cluster: 'research', title: 'Ad Longevity Is the Closest Thing to a Public Conversion Signal', label: 'METHOD', blurb: 'One ad ran 564 days on a single creative. Nobody keeps paying for a losing ad.', target: 'meta ad library longevity' },
  { slug: 'the-vibe-coding-wall', cluster: 'research', title: 'The Vibe-Coding Wall', label: 'MARKET INSIGHT', blurb: 'One company launched 80 ad variants in two weeks around a single idea: you already tried building it with AI, and hit a wall.', target: 'ai app builder limitations' },
  ...
  { slug: 'carousels-are-depth-not-reach', cluster: 'research', title: 'Carousels Are Depth, Not Reach', label: 'FORMAT STUDY', blurb: 'A tenth of the likes of a reel, and the same number of comments. What that means for what you post.', target: 'instagram carousel vs reel' },
  { slug: '44-percent-of-ai-enriched-contacts-are-wrong', cluster: 'research', title: '44% of AI-Enriched B2B Contacts Were the Wrong Employer', label: 'DATA QUALITY', blurb: 'Measured across 254 contacts at 100 companies. Two failure modes, and the check that catches both.', target: 'b2b data enrichment accuracy' },
  ...
  { slug: 'what-20-sites-taught-me-about-traffic', cluster: 'research', title: 'What 20 Sites Taught Me About Traffic', label: 'ANALYTICS STUDY', blurb: 'A year of cookieless analytics across a portfolio nobody is paying to promote.', target: 'small website traffic benchmarks' },
  { slug: 'the-false-zero-machine', cluster: 'research', title: 'The False-Zero Machine', label: 'METHOD', blurb: 'Ad-library search ranks the wrong page first and returns a confident zero. How to detect it before it poisons your analysis.', target: 'meta ad library search accuracy' },
];
